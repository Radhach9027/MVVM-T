...
extension HomeViewController {
    @IBAction func homeDetailsButtonPressed(_ sender: UIButton) {
        if let controller: HomeDetailsViewController = Traveller.route.push(story: .tab, controller: .detail, animated: true, modelTransistion: .coverVertical, modelPresentation: .currentContext).perform() {
