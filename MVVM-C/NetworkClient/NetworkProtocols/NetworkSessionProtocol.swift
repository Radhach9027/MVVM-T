...
protocol NetworkSessionProtocol: class {
...
extension URLSession: NetworkSessionProtocol {
    ...
    static var queue:(Int, QualityOfService) -> OperationQueue = { (maxOperationCount, userService) in
    ...
    static var configuration:(Double, String?) -> URLSessionConfiguration = { (timeInterval, identifier) in
