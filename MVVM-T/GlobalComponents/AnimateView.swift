...
class AnimatedView: UIView {
    ...
    func present(message: AnimatedViewMessage, postion: AnimatePosition, bgColor: UIColor, image: UIImage? = nil) {
...
private extension AnimatedView {
    ...
    func addConstrints(postion: AnimatePosition, message: AnimatedViewMessage) {
        defer {
